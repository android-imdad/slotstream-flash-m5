...
extension Catalogue {
    static var t0Checks: [Check] {
        [
            ...
            Check("flash-identity", tier: .t0) { try Diagnostics.flashIdentity() },
            Check("flash-observation", tier: .t0) { try Diagnostics.flashObservation() },
            Check("flash-neuron-scoring", tier: .t0) { try Diagnostics.flashNeuronScoring() },
            Check("flash-neuron-mask", tier: .t1) { try Diagnostics.flashNeuronMask() },
            ...
            Check("read-scheduling", tier: .t0) { Diagnostics.readScheduling() },
            Check("exact-widening", tier: .t0) { Diagnostics.exactWidening() },
