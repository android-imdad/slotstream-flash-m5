...
def compare(directories):
    ...
    return {'format': 'slotstream-prefill-comparison-v1', 'schema_version': 1,
            ...
            'validator_correction': 'Version 1 incorrectly required integrationCandidate fusedRoPE=true rather than platform-selected deploymentCandidate=false; numerical gates are unchanged.',
