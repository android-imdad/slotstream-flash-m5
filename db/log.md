...
## [2026-09-16 05:31] update | records/measurements/jang-prefill-chunks-2026-09-16.md
Completed Plan018: eighteen serial fixed-budget prefill arms, independent artifact and median review, and manual output assessment. Larger chunks pass the timing-only shortlist; preserve the marginal decode guardrail, output-work differences and shared code-task error. Matched numerical qualification remains pending and defaults unchanged. Raw evidence and frozen fixtures saved; brain, projection, claims and whitespace checks pass. No owned model or benchmark waiter remains.

## [2026-09-16 06:06] update | records/measurements/jang-prefill-qualification-2026-09-16.md
Completed Plan019 with a matched deployed Engine capture instrument, two exact ordinary-output smokes and six bounded numerical captures. Canonical evaluation rejects 1024 on three prose retained-state fields; code/logits/aggregate routing pass. Preserved evaluator metadata and route-classification corrections without changing raw tensors or thresholds. Task and extended timing runs skipped after numerical rejection; 512 remains a control, not independently qualified. Build, 55 native groups, final comparator tests, static/brain/claims/projection and whitespace checks pass. Defaults unchanged; no owned model or benchmark process remains.

## [2026-09-16 06:34] update | records/measurements/jang-prefill-512-qualification-2026-09-16.md
Completed Plan020: prospectively selected 384 midpoint control, fresh 256/384/512 captures on previously unused prompts, actual deployed controls and priced schedules/pools. Both prompts reject 512 on retained-state and aggregate-prefill-routing gates; full logit/greedy/integer-state checks pass. Independent audit verified all native hashes and metrics and ruled out exported KV row alignment as the discrepancy source. Conditional task/timing runs not launched after rejection. Build, 55 native groups, 40 host tests, brain/claims/projections and whitespace checks pass. Keep 256 default and prior decode gains; no owned model or benchmark processes remain.
